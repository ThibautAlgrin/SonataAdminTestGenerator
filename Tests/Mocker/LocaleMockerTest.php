...
use Algrin\SonataAdminTestsGeneratorBundle\Mocker\LocaleMocker;

class LocaleMockerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGenerate() {
        $mocker = new LocaleMocker();
        $value = $mocker->generate();
        $this->assertTrue(in_array(str_replace('"', "", $value), $this->localeData));
    }
}
